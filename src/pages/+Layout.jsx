...
export default function Layout({ children }) {
  return (
    <div className="max-w-6xl m-auto px-6 lg:px-4">
      <Header />
...
function Content({ children }) {
  return <main className="flex flex-col gap-24">{children}</main>;
}

function Footer() {
  return (
    <footer className="font-poppins pt-24 pb-20">
      <div className="flex justify-between flex-wrap gap-y-10 gap-x-6">
        <div className="min-w-full lg:min-w-fit">
          <h3 className="text-gray-950 dark:text-white font-medium text-[42px] mb-8 leading-8">
            Jadoo.
          </h3>
        ...
        <div>
          ...
          <ul className="flex gap-2 flex-wrap">
            <li>
              <a
                href=""
                className="flex items-center gap-1 px-4 py-2 text-white dark:text-black bg-black dark:bg-white rounded-full focus:outline-orange-500"
              >
                <PlayStore className="shrink-0" />
